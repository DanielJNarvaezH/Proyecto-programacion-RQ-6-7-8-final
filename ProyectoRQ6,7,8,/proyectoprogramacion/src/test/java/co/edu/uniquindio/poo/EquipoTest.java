...
public class EquipoTest {
    ...
    public void registrarEquipo() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15),
                LocalDate.now().plusDays(15), (byte) 24, (byte) 0, 0, TipoTorneo.LOCAL, TipoTorneoGenero.HOMBRES);
    ...
    public void inscripcionCerrada() {
        ...
        // Almacenar los datos de prueba Torneo{Copa Mundo\|fechaActual+ 1mes\|
        // fechaActual - 15 días\|fechaActual-1 días\|24\|0\|0\|LOCAL}
        // Equipo{Uniquindio}
        // Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300}

        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15),
                LocalDate.now().minusDays(1), (byte) 24, (byte) 0, 0, TipoTorneo.LOCAL, TipoTorneoGenero.MUJERES);
    ...
    public void inscripcionNoAbierta() {
        ...
        // Almacenar los datos de prueba Torneo{Copa Mundo\|fechaActual+ 1mes\|
        // fechaActual + 1 día\|fechaActual+15 días\|24\|0\|0\|LOCAL} Equipo{Uniquindio}
        // Representante{Robinson,Pulgarin,rpulgarin@email.com,6067359300}
