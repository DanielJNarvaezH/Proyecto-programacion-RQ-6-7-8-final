...
public class JugadorTest {
    ...
    public void registrarJugadorEquipo() {
        ...
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",
                LocalDate.now().minusYears(15), TipoGenero.HOMBRE);
    ...
    public void registrarJugadorTorneo() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15),
                LocalDate.now().plusDays(15), (byte) 24, (byte) 18, 0, TipoTorneo.LOCAL, TipoTorneoGenero.MIXTO);
        var estadistica = new Estadistica();
        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300");
        var equipo = new Equipo("Uniquindio", representante, estadistica);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",
    ...
    public void registrarJugadorTorneoSinLimiteEdad() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15),
                LocalDate.now().plusDays(15), (byte) 24, (byte) 0, 0, TipoTorneo.LOCAL, TipoTorneoGenero.MIXTO);
        var estadistica = new Estadistica();
        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300");
        var equipo = new Equipo("Uniquindio", representante, estadistica);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",
                LocalDate.now().minusYears(21), TipoGenero.HOMBRE);
    ...
    public void registrarJugadorTorneoInscripcionesCerradas() {
        ...
        Torneo torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15),
                LocalDate.now().plusDays(1), (byte) 24, (byte) 18, 0, TipoTorneo.LOCAL, TipoTorneoGenero.MIXTO);

        var representante = new Persona("Robinson", "Pulgarin", "rpulgarin@email.com", "6067359300");
        var estadistica = new Estadistica();
        var equipo = new Equipo("Uniquindio", representante, estadistica);
        var jugador = new Jugador("Christian", "Candela", "chrcandela@email.com", "6067431234",
                LocalDate.now().minusYears(15), TipoGenero.MUJER);
    ...
    public void registrarJugadoresRepetidosTorneo() {
        ...
        var torneo = new Torneo("Copa Mundo", LocalDate.now().plusMonths(1), LocalDate.now().minusDays(15),
                LocalDate.now().plusDays(15), (byte) 24, (byte) 18, 0, TipoTorneo.LOCAL, TipoTorneoGenero.HOMBRES);
